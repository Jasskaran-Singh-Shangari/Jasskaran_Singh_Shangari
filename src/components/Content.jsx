  ...
  return (
    <div className="absolute top-0 left-0 text-center">
        <section id="Hero" className="text-white flex lg:justify-center lg:items-center lg:flex-row flex-col min-h-screen min-w-screen ">
            ...
            <a href="/Jasskaran_Singh_Shangari_Resume.pdf" download="Jasskaran Singh Shangari" onClick={downloadResume}><img className="rounded-full border-solid border-white border-[10px] absolute right-25 top-20  hover:scale-110 cursor-pointer transition-transform duration-300 w-[400px] h-[400px]" loading='eager'  src={assets.Placeholder1}  /></a>
        </section>
